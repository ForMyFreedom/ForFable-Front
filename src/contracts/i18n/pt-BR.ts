...
export const ptBR: LanguageContract = {
    ...
    PromptCreatedSuccessfully: "Prompt criado com sucesso",
    Title: "Título",
    MaxSizePerExtension: "Tamanho máximo por extensão (caracteres)",
    Text: "Texto",
    LimitOfExtensions: "Limite de extensões",
    TimeForAvanceInMinutes: "Tempo para avanço (minutos)",
}